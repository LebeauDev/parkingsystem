...
public class ParkingDataBaseIT {
    ...
    public void testParkingLotExit(){
        ...
        //System.out.println("OOOOOOOOOOOOOOO "+ticketDAO.getTicket("ABCDEF").getOutTime());
        assertEquals( ticketDAO.getTicket("ABCDEF").getOutTime().toGMTString(), new Date().toGMTString());
    }
